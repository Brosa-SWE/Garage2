...
namespace Garage2.Models
{
	...
	{
		public static readonly int GarageSize = 300;					// available parking spaces
		public static readonly bool EnableRandomCheckIn = true;		// Enable CheckIn of Random Vehicles into DB Table Parked Vehicles
